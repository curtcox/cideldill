...
def test_resolve_server_url_uses_env_variable_first(monkeypatch) -> None:
...
def test_resolve_server_url_reads_discovery_file(monkeypatch) -> None:
...
def test_resolve_server_url_falls_back_to_default(monkeypatch) -> None:
...
def test_resolve_server_url_ignores_invalid_discovery_file(monkeypatch) -> None:
...
def test_configured_server_url_takes_precedence(monkeypatch) -> None:
