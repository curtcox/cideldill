...
def test_web_ui_has_toggle_breakpoint_functionality():
    ...
    # Check for remove/toggle breakpoint functionality  
    assert "remove" in HTML_TEMPLATE.lower() or "delete" in HTML_TEMPLATE.lower() or \
           "toggle" in HTML_TEMPLATE.lower(), \
        "Web UI should have remove/toggle breakpoint functionality"
